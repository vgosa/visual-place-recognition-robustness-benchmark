...
def parse_arguments():
    ...
    parser.add_argument("--network", type=str, default=None, choices=["cricavpr", "cosplace", "dinov2", "mixvpr", "resnetgcl", "vitgcl"], help="Override the default model class and use the custom network for evaluation")
    # Model parameters
